                ...
                <div className='flex flex-col gap-12 lg:grid lg:grid-cols-2 lg:gap-16 items-center '>
                    <div className='flex flex-col gap-6 lg:order-first order-last'>
                        ...
                        <p className='text-xl text-secondary-foreground/80'>
                            Ob Online-Präsenz, Kundenportal oder interne App – ich entwickle digitale Lösungen, die auf deine Unternehmensziele
                            einzahlen.
                        </p>
                        ...
                        <div className='flex flex-wrap gap-6 mt-4'>
                            ...
                            <div className='flex items-center gap-2'>
                                ...
                                <span className='text-sm font-medium'>Custom Web Apps</span>
                            </div>
                        </div>
                    </div>
