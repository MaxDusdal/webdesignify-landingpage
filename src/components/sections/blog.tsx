...
export default function Blog() {
  ...
  useEffect(() => {
    ...
    const currentBlogRef = blogRef.current;
    ...
    observer.observe(currentBlogRef);

    return () => {
      if (currentBlogRef) {
        observer.unobserve(currentBlogRef);
      }
    };
  }, []);
  ...
  return (
    <section
      id="blog"
      className="w-full pt-12 md:pt-24 bg-background/50"
      ref={blogRef}
    >
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12">
          <div className="space-y-2 mb-6 md:mb-0">
            ...
            <p className="max-w-[500px] text-muted-foreground">
              Gedanken, Tipps und Erkenntnisse zum Webentwicklung und digitalen
              Marketing
            </p>
          </div>
