...
const MyLottieComponentDynamic = dynamic(
  () =>
    import("../hero-lottie").then((mod) => ({
      default: mod.MyLottieComponentDynamic,
    })),
  {
    ssr: false,
    loading: () => (
        ...
        <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2 lg:gap-16 items-center ">
          <div className="flex flex-col gap-6 lg:order-first order-last">
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl">
              <span className="text-accent">Digitale Lösungen,</span> die Ihr
              Unternehmen voranbringen.
            </h1>
            <p className="text-xl text-secondary-foreground/80">
              Ob Online-Präsenz, Kundenportal oder interne App – ich entwickle
              digitale Lösungen, die auf Ihre Unternehmensziele einzahlen.
            </p>
