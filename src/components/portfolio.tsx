  ...
  return (
    <section id="portfolio" className="w-full py-12 md:py-24 bg-background">
      <div className="container px-4 md:px-6 mx-auto max-w-7xl">
        ...
        <div
          className="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-8 mb-8"
        ...
        >
          ...
          <div className="lg:col-span-3 relative group overflow-hidden rounded-lg">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 transform transition-transform duration-300 group-hover:translate-y-[-40px]">
        ...
        <div className="flex justify-center items-center gap-4 md:gap-8 mt-8 flex-wrap">
          {caseStudies.map((study, index) => (
            ...
            >
              <Image
                src={study.company.logo || "/placeholder.svg"}
