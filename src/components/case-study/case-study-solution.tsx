      ...
      <div className="container px-4 md:px-6 mx-auto max-w-7xl">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              {caseStudy.inHouseSoftware && (
                <div className="mt-6 pt-6 border-t border-border/40">
                  <h3 className="text-xl font-semibold mb-4">
                    {caseStudy.inHouseSoftware.title}
                  </h3>
                  <p className="text-muted-foreground mb-4">
                    {caseStudy.inHouseSoftware.description}
                  </p>
                  ...
                  {caseStudy.inHouseSoftware.cta?.link && (
                    <Button className="group" asChild>
                      <Link
                        href={caseStudy.inHouseSoftware.cta.link}
                        target="_blank"
                      >
            ...
            >
              {caseStudy.solution?.tabs &&
                caseStudy.solution.tabs.length > 0 && (
                  <Tabs defaultValue={defaultTabValue} className="w-full">
                    <TabsList
                      className={`grid grid-cols-${caseStudy.solution.tabs.length} mb-8`}
                    >
