                ...
                >
                    <Collapsible
                        ...
                        className={`border border-border/40 rounded-lg transition-all duration-300 ${
                            openIndex === index ? 'bg-card shadow-md scale-[1.01]' : 'bg-background hover:bg-muted/50 hover:scale-[1.005]'
                        }`}
                    >
                        <CollapsibleTrigger asChild>
                            <button
                                className={`flex cursor-pointer w-full rounded-md px-6 py-4 text-left bg-white transition-all duration-300 ${
                                    openIndex === index ? 'text-primary font-medium' : 'hover:text-primary/80'
                                }`}
                            >
                                <div className='flex w-full items-start'>
                                    <div className='text-lg font-medium grow mr-4 whitespace-normal' style={{ wordWrap: 'break-word' }}>
                                        {faq.question}
                                    </div>
                                    <motion.div
