...
export const metadata: Metadata = {
  title: "Online-Strategieoptimierung aus Mannheim - Webdesignify",
  description:
    "Ihr Online-Auftritt muss auch einen geschäflichen Mehrwert bieten. Ich optimiere die Ergebnisse  aus Online-Auftritten, seien es Sign-Ups, Demos oder Verkäufe. Zusammen mit Ihnen können wir Ihren Online-Auftritt zu einem wichtigen Instrument für Ihr Geschäft machen.",
};
  ...
  const websiteServices = [
    {
      ...
      title: "On-Page-SEO",
      description:
        "Page-Load-Time-, Content- und Keyword-Optimierung sowie Metadaten gewährleisten bestmögliches Google-Ranking.",
    },
    {
      icon: "Server",
