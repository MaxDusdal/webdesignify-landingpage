...
export default function WebDesign() {
    ...
    const timelineSteps: TimelineStep[] = [
        ...
        },
        {
            ...
            description: 'Aus dem gemeinsam erarbeiteten Konzept ensteht ein erstes Design welches genau auf Ihre Zielgruppe optimiert ist.',
        },
        {
            number: 3,
            title: 'Umsetzung',
            description: 'Wenn Sie mit Ihrem Design zufrieden sind dann setze ich Ihr Design in eine vollfunktionsfähige Webseite um.',
        },
    ];
