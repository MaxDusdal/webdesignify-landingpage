        ...
        },
        {
            ...
            fields: [
                ...
                },
                {
                    ...
                    admin: {
                        description: 'Label der Statistik (z.B. "Verbesserung der Suchleistung")',
                    },
                },
            ],
            minRows: 1,
                ...
                },
                {
                    ...
                    fields: [
                        ...
                        },
                        {
                            ...
                            label: 'Tab Value',
                            admin: {
                                description: 'Eindeutige Kennung für diesen Tab (z.B. "website", "system", "results")',
                            },
                        },
                        {
                            name: 'image',
                    ...
                    admin: {
                        description: 'Füge 1 bis 3 Tabs hinzu, um verschiedene Aspekte der Lösung zu zeigen',
                    },
                },
            ],
        },
                ...
                },
                {
                    ...
                    fields: [
                        ...
                        },
                        {
                            ...
                            admin: {
                                description: 'Add vorher/nachher Statistiken für diese Kategorie',
                            },
                        },
                    ],
                    admin: {
